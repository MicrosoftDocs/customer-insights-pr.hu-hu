---
title: Javasolt szegmensek (előzetes verzió)
...
A Customer Insights felhasználójaként valószínűleg egy sor [olyan intézkedés jött létre](measures.md), amelyek segítenek nyomon követni a fő teljesítménymutatókat (KPI-ket). Fontos megérteni, hogy bizonyos attribútumok hogyan befolyásolják ezt a fő teljesítménymutatót szegmensek létrehozásában és egy erősen célzott kampány futtatásában.   
