---
title: Tranzakció lemorzsolódása előrejelzés (videót tartalmaz)
...
> [!TIP]
> Próbálja ki az oktatóanyagot egy tranzakció lemorzsolódáshoz előrejelzés mintaadatok felhasználásával: [Tranzakció lemorzsolódás előrejelzés minta útmutató](sample-guide-predict-transactional-churn.md).
...
1. Jelölje ki a **Vevő lemorzsolódási modellcsempét**, és válassza a A modell használata **lehetőséget**.
...
1. Adja meg a lemorzsolódás meghatározásához használt napok számát a **Lemorzsolódás definíció mezőben**. Például, ha egy ügyfél nem vásárolt az elmúlt 30 napban, vállalkozása számára lemorzsolódónak tekinthető. 
