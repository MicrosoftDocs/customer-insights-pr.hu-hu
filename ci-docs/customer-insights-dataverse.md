...
A rendszergazdák beállíthatják a Customer Insights szolgáltatást úgy, hogy [egy meglévő Dataverse környezetet](create-environment.md) használjon a Customer Insights környezet létrehozásakor. Azáltal, hogy megadja az URL-címet a Dataverse környezetnek, az új Customer Insights környezethez kapcsolódik. Az ügyfélelemzéseket és Dataverse a környezeteket ugyanabban a régióban kell üzemeltetni. 
...
> [!NOTE]
> Ha a szervezetek már használják Dataverse a bérlőjükben, fontos megjegyezni, hogy [Dataverse a környezet létrehozását egy rendszergazda](/power-platform/admin/control-environment-creation) vezérli. Ha például új Customer Insights-környezetet állít be a szervezeti fiókjával, és a rendszergazda letiltotta a próbaverziós környezetek létrehozását Dataverse mindenki számára, kivéve a rendszergazdákat, akkor nem hozhat létre új próbaverziós környezetet.
> 
